...
double average(Student.score, int size);
...
//**************************************************************
double average(Student pointer.score[], int size)
{
    double sum = 0;
    double* pointer = pointer.score;  // Pointer to next array entry to be summed
